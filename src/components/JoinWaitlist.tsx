...
export const JoinWaitlist = () => {
    ...
    return (
        <section id='waitlistFrom' className='text-white w-full my-[20px]'>
                <div className='bg-[rgba(0,0,0,0.8)] blurr-border rounded-lg px-3 md:px-0 flex flex-col justify-center items-center space-y-6 mx-auto w-full md:w-[575px] overflow-hidden'>
                    <ul
