...
const APIDemo = () => {
    return (
        <section id='apiDemo' className='pt-[70px] md:pt-[100px] pb-[120px] mt-[-20px] relative rounded-t-[22px] text-black z-0 bg-white w-[100vw] h-auto min-h-[100vh] cabinet-grotesk-medium overflow-hidden'>
